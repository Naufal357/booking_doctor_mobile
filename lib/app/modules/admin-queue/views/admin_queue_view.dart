...
class AdminQueueView extends GetView<AdminQueueController> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Data Antrian'), actions: [
          IconButton(
      ...
      body: PaginateFirestore(
            ...
            builder: (_, snapshot) {
              ...
              return FutureBuilder(
                ...
                builder: (_, snapshot) {
                  ...
                  return ListTile(
                    leading: CircleAvatar(child: Text(data.number.toString())),
                    ...
                    onTap: () => Get.toNamed('/admin/queues/edit', arguments: snapshots[index].id),
                  );
                },
              );
            },
        ...
        onEmpty: Center(
          child: Text('Antrian Pesanan masih kosong'),
        ),
      ),
    );
  }
